...
import { setCurrentPage, setItemsPerPage } from '../../redux/slices/fitersSlice';
...
const Pagination = () => {
   ...
   const onSelectItemsPerPage = (option) => {
         ...
         <div className={styles.root}>
            ...
            {paginationCount > 1 && (
               <ul className={styles.pagination}>
                  ...
                  <li
                     className={currentPage != paginationCount ? styles.active : styles.cursorNone}
                     onClick={
